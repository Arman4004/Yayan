...
def moch_yayan():
    ...
    print ' [%s2%s]. Clone id from  public'%(O,N);time.sleep(0.03)
    print ' [%s3%s]. Clone id from total followers'%(O,N);time.sleep(0.03)
    print ' [%s4%s]. Clone id from like postingan'%(O,N);time.sleep(0.03)
